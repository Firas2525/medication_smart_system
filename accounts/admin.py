...
class UsersAdmin(UserAdmin):
    ...
    fieldsets = (
        ...
        #  ضفنا gender إلى معلومات المريض
    ...
    # مربع بحث في أعلى صفحة القائمة للبحث في الحقول المحددة.
...
order_by('is_approved', '-date_joined')	ترتيب مخصص: غير الموافق عليهم أولاً، ثم الأحدث
    ...
    def save_model(self, request, obj, form, change):
        """عند الموافقة على طبيب،"""
        if change and 'is_approved' in form.changed_data and obj.is_approved:
            #    ممكن  إرسال بريد إلكتروني أو إشعار داخل التطبيق او إضافة اشعار للطبيب بأنه تم قبوله لاحقا 
            pass
