...
- الوصف: تعديل بيانات دواء في المكتبة العامة.
- الصلاحيات: طبيب أو مشرف أو مسؤول (`admin`).
- ملاحظة: المرضى لا يمكنهم تعديل الأدوية العامة.
...
- الوصف: حذف دواء من المكتبة العامة.
- الصلاحيات: طبيب أو مشرف أو مسؤول (`admin`).
- ملاحظة: المرضى لا يمكنهم حذف الأدوية العامة.
- Body: لا يوجد.
- رد نجاح (200):
  ```json
...
- رد خطأ (403) إذا حاول المريض إضافة دواء عبر المسار الخاطئ أو لم يكن مخوله.
